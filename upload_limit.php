...
function mt_add_pages() {
    ...
    add_menu_page(__('upload_max_file_size', 'menu-test'), __('PBP IUL', 'menu-test'), 'manage_options', 'upload_max_file_size', 'upload_max_file_size');
}

//plugin dash board page
function upload_max_file_size() {
    echo "<h2>" . __('PBP INCREASE UPLOAD LIMIT', 'menu-test') . "</h2>";
